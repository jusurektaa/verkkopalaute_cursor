...
function saveFeedback(feedback) {
    ...
    let existingFeedback = JSON.parse(localStorage.getItem('verkkopalaute_feedback') || '[]');
    ...
    localStorage.setItem('verkkopalaute_feedback', JSON.stringify(existingFeedback));
